...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'api_exception_subscriber' => 'getApiExceptionSubscriberService',
            'assets.context' => 'getAssets_ContextService',
            'assets.packages' => 'getAssets_PackagesService',
            'battle.battle_manager' => 'getBattle_BattleManagerService',
            'battle.power_manager' => 'getBattle_PowerManagerService',
            ...
            'link_serialization_subscriber' => 'getLinkSerializationSubscriberService',
            ...
            'pagination_factory' => 'getPaginationFactoryService',
            ...
            'twig' => 'getTwigService',
            'twig.battle_extension' => 'getTwig_BattleExtensionService',
    ...
    /**
     * Gets the 'api_exception_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\ApiExceptionSubscriber A AppBundle\EventListener\ApiExceptionSubscriber instance
     */
    protected function getApiExceptionSubscriberService()
    {
        return $this->services['api_exception_subscriber'] = new \AppBundle\EventListener\ApiExceptionSubscriber(true, $this->get('logger'));
    }
    ...
    /**
     * Gets the 'battle.battle_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Battle\BattleManager A AppBundle\Battle\BattleManager instance
     */
    protected function getBattle_BattleManagerService()
    {
        return $this->services['battle.battle_manager'] = new \AppBundle\Battle\BattleManager($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'battle.power_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Battle\PowerManager A AppBundle\Battle\PowerManager instance
     */
    protected function getBattle_PowerManagerService()
    {
        return $this->services['battle.power_manager'] = new \AppBundle\Battle\PowerManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('api_exception_subscriber', 'AppBundle\\EventListener\\ApiExceptionSubscriber');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'rest_api_sf3', 'user' => 'root', 'password' => 'coderslab', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_00d5a64719c51ccd4a40c9229afeab7d152f002c597942190bb1bb320e8a5505');
    ...
    /**
     * Gets the 'link_serialization_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Serializer\LinkSerializationSubscriber A AppBundle\Serializer\LinkSerializationSubscriber instance
     */
    protected function getLinkSerializationSubscriberService()
    {
        return $this->services['link_serialization_subscriber'] = new \AppBundle\Serializer\LinkSerializationSubscriber($this->get('router'), $this->get('annotation_reader'));
    }
    ...
    /**
     * Gets the 'pagination_factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Pagination\PaginationFactory A AppBundle\Pagination\PaginationFactory instance
     */
    protected function getPaginationFactoryService()
    {
        return $this->services['pagination_factory'] = new \AppBundle\Pagination\PaginationFactory($this->get('router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/_wdt|_profiler');
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api');
        ...
        $n = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $m, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($m, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'security_logout'));
        ...
        $o->setOptions(array('login_path' => 'security_login_form', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $p->setOptions(array('login_path' => 'security_login_form', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($l, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.database_users')), 'main', $a, $c), 2 => $n, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $m, 'main', $o, $p, array('check_path' => 'security_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5c5b2a15849fd6.86267222', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $l, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $m, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $m, 'security_login_form', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('twig.battle_extension'));
        ...
        $instance->addExtension(new \WhiteOctober\PagerfantaBundle\Twig\PagerfantaExtension('default', $this->get('white_october_pagerfanta.view_factory'), $b, $c));
    ...
    /**
     * Gets the 'twig.battle_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Twig\BattleExtension A AppBundle\Twig\BattleExtension instance
     */
    protected function getTwig_BattleExtensionService()
    {
        return $this->services['twig.battle_extension'] = new \AppBundle\Twig\BattleExtension();
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('main', 'security_logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['security.user.provider.concrete.database_users'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle:User', NULL, NULL);
    }
