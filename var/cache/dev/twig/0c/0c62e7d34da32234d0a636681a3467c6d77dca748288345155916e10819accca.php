...
class __TwigTemplate_573a6eeb96a4058b89eb92eef44a1a99bad3f55d4d284cd17e862c1062f2c8c8 extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        // line 18
        echo "    ";
        $context["total_time"] = ((twig_length_filter($this->env, $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "events", []))) ? (sprintf("%.0f", $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "duration", []))) : ("n/a"));
        // line 19
        echo "    ";
        ...
        // line 20
        echo "    ";
        $context["status_color"] = (((twig_length_filter($this->env, $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "events", [])) && ($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "duration", []) > 1000))) ? ("yellow") : (""));
        // line 21
        echo "
    ";
        // line 22
...
";
    ...
    ";
        ...
        if ($this->getAttribute(($context["profile"] ?? $this->getContext($context, "profile")), "parent", [])) {
            ...
            Sub-Request ";
            // line 109
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute(($context["profile"] ?? $this->getContext($context, "profile")), "getcollector", [0 => "request"], "method"), "requestattributes", []), "get", [0 => "_controller"], "method"), "html", null, true);
            echo "
            <small>
                ";
            // line 111
...
";
    ...
    public function getdump_request_data($__token__ = null, $__profile__ = null, $__events__ = null, $__origin__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 501
            $context["__internal_b4e3f2e02301b2a3cd600be39334ac4fefe40cecf219295e5e38a2399ff0e2ba"] = $this;
            // line 502
            echo "                {
                    \"id\": \"";
            // line 503
...
";
            // line 506
            echo $context["__internal_b4e3f2e02301b2a3cd600be39334ac4fefe40cecf219295e5e38a2399ff0e2ba"]->getdump_events(($context["events"] ?? $this->getContext($context, "events")));
            echo "
                    ]
                }
";
...
{% endmacro %}
", "WebProfilerBundle:Collector:time.html.twig", "/home/jaca/Workspace/Symfony/KNP/RestApi_2/RestApi_sf3/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/time.html.twig");
    }
}
