...
class __TwigTemplate_7c7b0b5d7036b94934c282e32d036f37cb215caf89215068982a64f00831894c extends Twig_Template
{
    ...
    <div class=\"block-exception-detected clear-fix\">
        ...
        echo "
            ...
            ";
        // line 19
        $context["previous_count"] = twig_length_filter($this->env, $this->getAttribute(($context["exception"] ?? $this->getContext($context, "exception")), "allPrevious", []));
        // line 20
        echo "            ";
        if (($context["previous_count"] ?? $this->getContext($context, "previous_count"))) {
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["exception"] ?? $this->getContext($context, "exception")), "allPrevious", []));
...
";
        ...
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 40
            echo "    ";
            $this->loadTemplate("@Twig/Exception/traces.html.twig", "TwigBundle:Exception:exception.html.twig", 40)->display(["exception" => $context["e"], "position" => $context["position"], "count" => ($context["previous_count"] ?? $this->getContext($context, "previous_count"))]);
        }
        $_parent = $context['_parent'];
...
";
        ...
        <div class=\"logs clear-fix\">
            ...
            ";
            // line 56
            if ($this->getAttribute(($context["logger"] ?? $this->getContext($context, "logger")), "counterrors", [])) {
                // line 57
                ...
                echo " error";
                echo ((($this->getAttribute(($context["logger"] ?? $this->getContext($context, "logger")), "counterrors", []) > 1)) ? ("s") : (""));
                echo "
                    </span>
                </div>
            ";
        ...
        <div id=\"logs\">
            ";
            // line 66
            $this->loadTemplate("@Twig/Exception/logs.html.twig", "TwigBundle:Exception:exception.html.twig", 66)->display(["logs" => $this->getAttribute(($context["logger"] ?? $this->getContext($context, "logger")), "logs", [])]);
            // line 67
            echo "        </div>
    </div>
";
...
";
        // line 91
        $this->loadTemplate("@Twig/Exception/traces_text.html.twig", "TwigBundle:Exception:exception.html.twig", 91)->display(["exception" => ($context["exception"] ?? $this->getContext($context, "exception"))]);
        // line 92
        echo "
...
//]]></script>
", "TwigBundle:Exception:exception.html.twig", "/home/jaca/Workspace/Symfony/KNP/RestApi_2/RestApi_sf3/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views/Exception/exception.html.twig");
    }
}
