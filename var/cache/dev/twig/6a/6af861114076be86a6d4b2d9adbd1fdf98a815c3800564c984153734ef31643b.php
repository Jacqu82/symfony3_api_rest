...
class __TwigTemplate_cfbd05fe3dcd7f4e385dc5f19f6a4618ee83d7d7aaea73f02f2b2137025f0e97 extends Twig_Template
{
...
";
        ...
        if (($this->getAttribute(($context["trace"] ?? null), "file", [], "any", true, true) && $this->getAttribute(($context["trace"] ?? null), "line", [], "any", true, true))) {
            // line 7
            echo "        in ";
            echo $this->getAttribute(($context["trace"] ?? $this->getContext($context, "trace")), "file", []);
            echo " line ";
...
{% endif %}
", "TwigBundle:Exception:trace.txt.twig", "/home/jaca/Workspace/Symfony/KNP/RestApi_2/RestApi_sf3/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views/Exception/trace.txt.twig");
    }
}
