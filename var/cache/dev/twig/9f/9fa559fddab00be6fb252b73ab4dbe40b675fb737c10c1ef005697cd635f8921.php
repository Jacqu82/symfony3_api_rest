...
class __TwigTemplate_3cbcd920748c77fa81ee7cb10e55533b917d83ab398adbf511d65d504cc29894 extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        if ((($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "counterrors", []) || $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "countdeprecations", [])) || $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "countscreams", []))) {
            ...
            // line 8
            echo "            ";
            $context["status_color"] = (($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "counterrors", [])) ? ("red") : ((($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "countdeprecations", [])) ? ("yellow") : (""))));
            // line 9
            echo "            ";
    ...
    public function block_menu($context, array $blocks = [])
    {
        ...
        echo (($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "counterrors", [])) ? ("error") : ((($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "countdeprecations", [])) ? ("warning") : (""))));
        echo " ";
        ...
        if (($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "counterrors", []) || $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "countdeprecations", []))) {
            ...
            echo "            <span class=\"count\">
                <span>";
            // line 41
            echo twig_escape_filter($this->env, (($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "counterrors", [])) ? ($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "counterrors", [])) : ($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "countdeprecations", []))), "html", null, true);
            echo "</span>
            </span>
        ";
        }
...
$context["log"], "priorityName", []), [0 => "NOTICE", 1 => "WARNING"])) ? ("status-warning") : (""))))));
                ...
                // line 163
                echo $context["helper"]->getrender_log_message($this->getAttribute($context["loop"], "index", []), $context["log"], ($context["is_deprecation"] ?? $this->getContext($context, "is_deprecation")));
                echo "</td>
                </tr>
            ";
                ++$context['loop']['index0'];
        ...
        ";
            ...
            <li>
                ...
                ";
                        ...
                        if (($context["file_name"] ?? $this->getContext($context, "file_name"))) {
                            ...
                            echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\CodeExtension')->formatFile($this->getAttribute($context["call"], "file", []), $this->getAttribute($context["call"], "line", []), ($context["file_name"] ?? $this->getContext($context, "file_name")));
                            echo ")</span>
                ";
                        }
                        // line 207
            ...
            ";
                ...
                <strong>Context</strong>: ";
                    // line 216
                    echo twig_escape_filter($this->env, twig_replace_filter(twig_jsonencode_filter($this->getAttribute(($context["log"] ?? $this->getContext($context, "log")), "context", []), (64 | 256)), ["{\"" => "{ \"", "\"}" => "\" }", "\":{" => "\": {", "\":\"" => "\": \"", "\",\"" => "\", \""]), "html", null, true);
                    // line 218
                    echo "
            </span>
        ";
...
{% macro render_log_message(log_index, log, is_deprecation = false) %}
    ...
    {% endif %}
{% endmacro %}
", "WebProfilerBundle:Collector:logger.html.twig", "/home/jaca/Workspace/Symfony/KNP/RestApi_2/RestApi_sf3/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/logger.html.twig");
    }
}
